...
function isTournament(details: Tournament | Deck | SellingCard | null): details is Tournament {
    return (details as Tournament).location !== undefined;
  }
  
  function isDeck(details: Tournament | Deck | SellingCard | null): details is Deck {
